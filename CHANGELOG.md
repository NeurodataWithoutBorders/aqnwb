...
* Fixed Windows CI failure caused by HTTP 429 from DKRZ GitLab by converting vcpkg dependency installation to manifest mode with a pinned baseline. (@oruebel, [#312](https://github.com/NeurodataWithoutBorders/aqnwb/pull/312))
