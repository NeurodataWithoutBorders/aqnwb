...
* Enhanced the `schematype_to_aqnwb` utility script:
    ...
    * Updated the rendering of initialize methods to ensure inclusion of all owned parameters (including those in subgroups) and add rendering of default values (@oruebel, [#230](https://github.com/NeurodataWithoutBorders/aqnwb/pull/230))
