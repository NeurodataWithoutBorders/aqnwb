...
* Fixed HDF5 string type creation to explicitly use UTF-8 character set for fixed-length and variable-length strings in datasets and attributes, improving compatibility with hdmf/PyNWB string decoding (@copilot, [#316](https://github.com/NeurodataWithoutBorders/aqnwb/issues/316))
